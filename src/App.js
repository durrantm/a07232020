    ...
    if (zip.length === 5 && !isNaN(zip)) {
      ...
      axios.request(options)
        ...
        .then(function() {
          ...
          // This is the one I am trying to get to work with an object
          axios.request(optionsWeatherForecast)
            .then(function(response) {
              // this works but is clumsy and only grabs 5 days high temps, not all the other data and for 15 days
              setForecast5DayHighs ([
              ...
              // This is the "object" approach I want to use..
              console.log("== 1 forecast ==");
              console.log(forecast); // but this is not now populated
